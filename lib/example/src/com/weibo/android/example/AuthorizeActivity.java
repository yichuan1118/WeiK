...
public class AuthorizeActivity extends Activity {
	...
	private static final String CONSUMER_KEY = "2282257429";// 替换为开发者的appkey，例如"1646212860";
	private static final String CONSUMER_SECRET = "83d149fccf5760d3e7271e3355209e76";// 替换为开发者的appkey，例如"94097772160b6f8ffc1315374d8861f9";
		...
		mLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (v == mLogin) {
					...
					// Oauth2.0
					// 隐式授权认证方式
					mWeibo.setRedirectUrl("http://weik.metaisle.com/authorized");// 注意！！此处回调页内容应该替换为与appkey对应的应用回调页
